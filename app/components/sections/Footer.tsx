	...
	return (
		<>
			<footer className="max-w-7xl mx-auto mt-24 px-4 sm:px-6 sm:mt-32 lg:px-8">
				<div className="py-12 md:flex border-t md:items-center md:justify-between">
					<div className="flex justify-center space-x-6 md:order-2">
						...
						>
							<span className="sr-only">Twitter DevBaraus</span>
							<svg
								fill="currentColor"
								viewBox="0 0 24 24"
								className="h-6 w-6"
						...
						<a
							href="https://github.com/devbaraus/muggs_shop"
							target="_blank"
							className="text-gray-400 hover:text-gray-500"
						>
							<span className="sr-only">GitHub Muggs Shop</span>
							<svg
								fill="currentColor"
								viewBox="0 0 24 24"
								className="h-6 w-6"
