			...
			<div className='lg:grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-16'>
				...
				<div className='max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:col-span-3'>
					...
					<div className='mt-10 grid grid-cols-8 gap-x-6 gap-y-4'>
						<div
							className='w-full bg-gray-50 border border-transparent rounded-md py-3 px-4 flex items-center justify-between text-base text-gray-500 col-span-5'>
						...
						<div
							className='w-full bg-white rounded-md py-3 px-8 flex items-center justify-center text-lg font-medium text-gray-900 col-span-3'>
							{formatPrice(
